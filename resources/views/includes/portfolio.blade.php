    ...
    <div class="row">
        @foreach ($realisations as $realisation)
            <div class="col-sm-4 p-3">
                     <div class="content position-relative overflow-hidden text-center text-white rounded shadow bg-rea d-flex flex-column justify-content-center align-items-center px-3" style="background: linear-gradient(rgba(0, 0, 0, 0.6) 35%, rgba(0, 0, 0, 0.6)), url('{{url('storage/uploads/realisations/background/'.$realisation->background_path_small)}} ')">
                        <img src="{{url('storage/uploads/realisations/logo/'.$realisation->logo_path)}}" class="logo-project" alt="Logo {{$realisation->name}}">
