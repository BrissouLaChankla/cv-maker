                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="position-relative change-pic change-background-style pointer">
                                        <img src="{{ asset('img/global/realisation/your-background.webp') }}"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    <div class="position-relative change-pic change-logo-style pointer">
                                        ...
                                        <img src="{{ url('storage/realisations/'.$realisation->slug.'/logo.webp') }}"
                                            class="img-fluid ">
                                        <span class="text-white icon-hover">
                                            <i class="fas fa-camera-retro"></i>
                                        </span>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        {!! Form::file('background_path', ['class' => 'd-none']) !!}
                                        <div class="position-relative change-pic change-background-style pointer">
                                            <img src="{{ url('storage/realisations/'.$realisation->slug.'/background_small.webp') }}"
                                                class="img-fluid rounded">
                                            <span class="text-white icon-hover">
                                                <i class="fas fa-camera-retro"></i>
                                            </span>
