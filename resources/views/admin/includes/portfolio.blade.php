                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="position-relative change-pic change-logo-style pointer">
                                    <img src="{{ asset('storage/app/public/uploads/realisations/logo/exemple.png') }}"
                                        class="img-fluid ">
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="position-relative change-pic change-background-style pointer">
                                        <img src="{{ asset('storage/app/public/uploads/realisations/background/exemple.jpg') }}"
                        ...
                        <div class="col-md-6 mt-2">
                            <div class="row">
                                <div class="col-md-4">
                                    ...
                                    {!! Form::file('logo_path', ['class' => 'd-none']) !!}
                                    <div class="position-relative change-pic change-logo-style pointer">
                                        <img src="{{ asset('storage/app/public/uploads/realisations/logo/' . $realisation->logo_path) }}"
                                            class="img-fluid ">
                                        <span class="text-white icon-hover">
                                            <i class="fas fa-camera-retro"></i>
                                        </span>
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        {!! Form::file('background_path', ['class' => 'd-none']) !!}
                                        <div class="position-relative change-pic change-background-style pointer">
                                            <img src="{{ asset('storage/app/public/uploads/realisations/background/' . $realisation->background_path_small) }}"
                                                class="img-fluid rounded">
                                            <span class="text-white icon-hover">
                                                <i class="fas fa-camera-retro"></i>
                                            </span>
