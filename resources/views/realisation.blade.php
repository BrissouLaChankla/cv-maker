...
<div class="bandeau d-flex align-items-center position-relative" style="background:linear-gradient(rgba(0, 0, 0, 0.7), rgba(0, 0, 0, 0.7)), url('{{asset('storage/app/public/uploads/realisations/background/'.$realisation->background_path)}}')">
...
<div class="infos p-5">
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-lg-7">
                <div>
                    <img src="{{asset('storage/app/public/uploads/realisations/background/'.$realisation->background_path)}}" class="img-fluid rounded shadow" alt="">
                </div>
                <div class="row">
                    @foreach ($pictures as $picture)
                        <div class="col-6">
                            <img src="{{asset('storage/app/public/uploads/realisations/pictures/'.$picture->picture_path)}}" class="img-fluid rounded shadow-sm mt-3 " alt="Photo {{$picture->id}} de {{$realisation->name}}">                            
                        </div>
                    @endforeach
                </div>
            </div>
